...
---@alias Inochi2D.tuple3 {[1]:number,[2]:number,[3]:number}
---@alias Inochi2D.tuple2 {[1]:number,[2]:number}
...
---@field public translation Inochi2D.tuple3 The translation of the transform
---@field public rotation Inochi2D.tuple3 The rotation of the transform
---@field public scale Inochi2D.tuple2 The scale of the transform
---@field public pixelSnap boolean Whether the transform should snap to pixels
local Transform = Object:extend()

---@param a Inochi2D.tuple3
---@param b Inochi2D.tuple3
---@return Inochi2D.tuple3
...
---@param translation Inochi2D.tuple3?
---@param rotation Inochi2D.tuple3?
---@param scale Inochi2D.tuple2?
---@private
...
---@cast Transform +fun(translation:Inochi2D.tuple3?,rotation:Inochi2D.tuple3?,scale:Inochi2D.tuple2?):Inochi2D.Transform
...
---@field private trs love.Transform
---@field public translation Inochi2D.tuple2
---@field public rotation number
---@field public scale Inochi2D.tuple2
local Transform2D = Object:extend()

---@param translate Inochi2D.tuple2?
